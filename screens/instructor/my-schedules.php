...
// Get the current day code (e.g., 'M', 'T', 'W', 'Th', 'F', 'S', 'Su')
$currentDayCode = strtoupper(date('D')[0]); // 'D' returns 'Mon', 'Tue', etc.
...
$sql = "
    ...
    WHERE s.instructor = ? AND FIND_IN_SET(?, s.days)
    ORDER BY s.timeStart ASC
";

$stmt = $conn->prepare($sql);
$stmt->bind_param("ss", $instructorId, $currentDayCode);
$stmt->execute();
        ...
        <div class="schedules-container">
            ...
            <table class="schedule-table">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" style="text-align:center;">You don't have any schedules today.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
